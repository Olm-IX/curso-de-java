...
//		muito forte para criar uma classe nova...
...
//		-------------------------------------------------------------------------------------
//
//		Método 2: Utilizando a classe Collections e a Ordem Natural, com a implementação da
//		interface Comparable
//
//		É possível utilizar também com um Comparator como argumento
		Collections.sort(lista, new NomeDoClienteComparator());

		Collections.shuffle(lista);

//		Ou então passar só a lista e implementar, na classe Conta, a interface
//		Comparable (ordem natural!), tornando assim possível que a classe defina sua própria ordem!
		System.out.println("\nORGANIZADO POR NÚMERO DA CONTA - Usando Collections.sort() - Ordem Natural");
		Collections.sort(lista);
//		lista.sort(null); // É possível utilizar a ordem natural também com o .sort() ao passar null como argumento
...
//		Método 3: Jeito mais enxuto de definir o Comparator em Collections.sort() ou lista.sort();
...
//		abaixo é usando o retorno do método getSaldo
		lista.sort(Comparator.comparing(Conta::getSaldo)); // = Collections.sort(lista,
